...
3. **Actionable-фидбек.** Возвращайте конкретные проблемы, а не оценки. «Функция `parse_input` не обрабатывает пустые строки» — полезно. «7/10» — нет.
